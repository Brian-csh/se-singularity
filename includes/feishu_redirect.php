...
if ($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['HTTP_HOST'] == 'localhost') {
    $singularity_redirect = "http://localhost:8000/includes/feishu_callback.php?mode=".$mode;
}
else {
    $singularity_redirect = "https://singularity-eam-singularity.app.secoder.net/includes/feishu_callback.php?mode=".$mode;
}

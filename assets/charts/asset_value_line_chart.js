...
// var total_value_data = [
            ...
            //     40000
            // ];
var date_labels = Object.keys(asset_value_over_time);
var total_value_data = Object.values(asset_value_over_time);
...
// Area Chart Example
var ctx = document.getElementById("valueLineChart");
var valueLineChart = new Chart(ctx, {
    type: "line",
    data: {
        labels: date_labels,
        datasets: [{
